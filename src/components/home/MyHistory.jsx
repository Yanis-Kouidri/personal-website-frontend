...
function MyHistory() {
  ...
  const myHistoryP4 = `Actuellement en dernière année de mon parcours d'ingénieur, je suis en train d'effectuer un semestre d'échange à l'université de Tor Vergata à Rome. C'est 4 dernières années d'étude et d'apprentissage m'ont permises d'en aprendre plus sur ce que veux et sur ce que je ne veux pas faire, c'est pourquoi je compte commencer une thèse sur la thématique des réseaux informatique une fois mon diplome obtenu.`
